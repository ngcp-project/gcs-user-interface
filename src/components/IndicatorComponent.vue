...
export default {
  ...
  computed: {
    changeSpeedSize() {
      if (this.vehicleName == "ERU") {
        // if this is ERU: make the airspeed component larger
        return 300;
      } else {
...
<template>
  <div class="flight-indicators-container">
    ...
    <div
      ...
      :style="[
        vehicleName == 'ERU' ? { width: '70%', height: '75%', fontSize: '1.4em' } : { width: '45%' }
      ]"
    >
      <!-- if viewing ERU, only show speed -->
